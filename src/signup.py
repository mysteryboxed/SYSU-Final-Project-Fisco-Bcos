...
class Ui_Signup(object):
    def setupUi(self, Signup):
        ...
        Signup.resize(584, 416)
        self.centralwidget = QtWidgets.QWidget(Signup)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(260, 50, 71, 41))
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(188, 110, 215, 54))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(188, 180, 215, 50))
    ...
    def retranslateUi(self, Signup):
        ...
        self.label_2.setText(_translate("Signup", "用户名"))
        self.label_3.setText(_translate("Signup", "密码"))
        self.btn_register.setText(_translate("Signup", "确定注册"))
